<?php
/**
 * Launch 项目 - WordPress 后端配置
 * 
 * 文件位置: app/Projects/Launch/Structure/posttypes.php
 * 
 * 说明：
 * 1. 注册 'products' 自定义文章类型（CPT）
 * 2. 注册 'product_category' 和 'product_tag' 分类法
 * 3. 注册产品相关的元字段（meta fields）
 */
...
function register_product_category_taxonomy() {
    ...
    $args = [
        'labels'            => $labels,
        'hierarchical'      => true, // 像 category 一样分层
        'public'            => true,
        'show_ui'           => true,
...
function register_product_tag_taxonomy() {
    ...
    $args = [
        'labels'            => $labels,
        'hierarchical'      => false, // 像 tag 一样非分层
        'public'            => true,
        'show_ui'           => true,
        'show_admin_column' => true,
        'show_in_nav_menus' => true,
